...
module.exports = {
	apps: [
		...
		{
			name: "llmgateway-agentic-api",
			script: "./dist/serve.js",
			cwd: "./apps/agentic-api",
			env: {
				NODE_ENV: "production",
				PORT: 4000,
				...envConfig.parsed,
			},
			error_file: "/sites/agenticgateway.ai/logs/pm2/agentic-api-error.log",
			out_file: "/sites/agenticgateway.ai/logs/pm2/agentic-api-out.log",
			log_file: "/sites/agenticgateway.ai/logs/pm2/agentic-api-combined.log",
			time: true,
			instances: 1,
			exec_mode: "cluster",
			autorestart: true,
